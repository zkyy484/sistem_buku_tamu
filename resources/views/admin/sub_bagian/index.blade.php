...
@section('content')
    ...
    <div class="content-card">
        ...
        <div class="content-title-area">
            ...
            <a href="/admin/sub-bagian/create" class="btn-add">
                + Tambah Data
            </a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-container">
                                    <a href="/admin/sub-bagian/{{ $item->id_sub_bagian }}/edit" class="btn-table-action btn-edit">
                                        Edit
                                    </a>

                                    <form action="/admin/sub-bagian/{{ $item->id_sub_bagian }}" method="POST" class="inline-form" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                        @csrf
                                        @method('DELETE')
