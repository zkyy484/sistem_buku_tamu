...
@section('content')
    ...
    <div class="content-card">
        ...
        <div class="content-title-area">
            <h3>Tambah Tujuan Konsultasi</h3>
        ...
        <!-- Form Input -->
        <form action="/admin/tujuan-konsultasi" method="POST">
            @csrf

            <!-- Input Nama Tujuan Konsultasi -->
            <div class="form-group">
                <label for="tujuan_konsultasi">Nama Tujuan Konsultasi</label>
                <input type="text" id="tujuan_konsultasi" name="tujuan_konsultasi" placeholder="Contoh: Koordinasi Usaha, Keluhan Layanan" required autocomplete="off">
            </div>
